...
namespace Sample.API.Models
{
    ...
    public partial class AutonomousDatabaseNationalCharacterSet :
        Sample.API.Models.IAutonomousDatabaseNationalCharacterSet,
        Sample.API.Models.IAutonomousDatabaseNationalCharacterSetInternal,
        Sample.API.Runtime.IValidates
    {
        ...
        public string CharacterSet { get => ((Sample.API.Models.IAutonomousDatabaseNationalCharacterSetPropertiesInternal)Properties).CharacterSet; }
        ...
        private Sample.API.Models.IAutonomousDatabaseNationalCharacterSetProperties _properties;

        /// <summary>The resource-specific properties for this resource.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        internal Sample.API.Models.IAutonomousDatabaseNationalCharacterSetProperties Properties { get => (this._properties = this._properties ?? new Sample.API.Models.AutonomousDatabaseNationalCharacterSetProperties()); set => this._properties = value; }

        /// <summary>Internal Acessors for CharacterSet</summary>
        string Sample.API.Models.IAutonomousDatabaseNationalCharacterSetInternal.CharacterSet { get => ((Sample.API.Models.IAutonomousDatabaseNationalCharacterSetPropertiesInternal)Properties).CharacterSet; set => ((Sample.API.Models.IAutonomousDatabaseNationalCharacterSetPropertiesInternal)Properties).CharacterSet = value; }

        /// <summary>Internal Acessors for Properties</summary>
        Sample.API.Models.IAutonomousDatabaseNationalCharacterSetProperties Sample.API.Models.IAutonomousDatabaseNationalCharacterSetInternal.Properties { get => (this._properties = this._properties ?? new Sample.API.Models.AutonomousDatabaseNationalCharacterSetProperties()); set { {_properties = value;} } }
        ...
        Sample.API.Models.IProxyResourceInternal
    {
        ...
        /// <summary>The resource-specific properties for this resource.</summary>
        Sample.API.Models.IAutonomousDatabaseNationalCharacterSetProperties Properties { get; set; }
