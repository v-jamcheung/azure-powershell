...
namespace Sample.API.Models
{
    ...
    public partial class AutonomousDatabaseCharacterSetListResult :
        Sample.API.Models.IAutonomousDatabaseCharacterSetListResult,
        Sample.API.Models.IAutonomousDatabaseCharacterSetListResultInternal
    {
        ...
        private System.Collections.Generic.List<Sample.API.Models.IAutonomousDatabaseCharacterSet> _value;

        /// <summary>The AutonomousDatabaseCharacterSet items on this page</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public System.Collections.Generic.List<Sample.API.Models.IAutonomousDatabaseCharacterSet> Value { get => this._value; set => this._value = value; }
        ...
        Sample.API.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Sample.API.Models.IAutonomousDatabaseCharacterSet) })]
        System.Collections.Generic.List<Sample.API.Models.IAutonomousDatabaseCharacterSet> Value { get; set; }
