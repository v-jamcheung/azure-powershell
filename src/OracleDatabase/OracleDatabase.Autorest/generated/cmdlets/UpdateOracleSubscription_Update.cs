...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"OracleSubscription_Update", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IOracleSubscription))]
    [global::Sample.API.Description(@"Update a OracleSubscription")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/providers/Oracle.Database/oracleSubscriptions/default", ApiVersion = "2023-09-01-preview")]
    public partial class UpdateOracleSubscription_Update : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IOracleSubscriptionUpdate _properties;

        /// <summary>The type used for update operations of the OracleSubscription.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The type used for update operations of the OracleSubscription.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The type used for update operations of the OracleSubscription.",
        SerializedName = @"properties",
        PossibleTypes = new [] { typeof(Sample.API.Models.IOracleSubscriptionUpdate) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.IOracleSubscriptionUpdate Properties { get => this._properties; set => this._properties = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IOracleSubscription">Sample.API.Models.IOracleSubscription</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IOracleSubscription> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of UpdateOracleSubscription_Update</returns>
        public Sample.API.Cmdlets.UpdateOracleSubscription_Update Clone()
        {
            var clone = new UpdateOracleSubscription_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OracleSubscriptionsUpdate(SubscriptionId, Properties, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOracleSubscription_Update" /> cmdlet class.
        /// </summary>
        public UpdateOracleSubscription_Update()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IOracleSubscription> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IOracleSubscription
