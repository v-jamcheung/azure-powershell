...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AutonomousDatabase_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAutonomousDatabase_Update : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IAutonomousDatabaseUpdate _properties;

        /// <summary>The type used for update operations of the AutonomousDatabase.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The type used for update operations of the AutonomousDatabase.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The type used for update operations of the AutonomousDatabase.",
        SerializedName = @"properties",
        PossibleTypes = new [] { typeof(Sample.API.Models.IAutonomousDatabaseUpdate) })]
        [global::Sample.API.Category(global::Sample.API.ParameterCategory.Body)]
        public Sample.API.Models.IAutonomousDatabaseUpdate Properties { get => this._properties; set => this._properties = value; }
        ...
        /// <returns>a duplicate instance of UpdateAutonomousDatabase_Update</returns>
        public Sample.API.Cmdlets.UpdateAutonomousDatabase_Update Clone()
        {
            var clone = new UpdateAutonomousDatabase_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AutonomousDatabasesUpdate(SubscriptionId, ResourceGroupName, Autonomousdatabasename, Properties, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAutonomousDatabase_Update" /> cmdlet class.
        /// </summary>
        public UpdateAutonomousDatabase_Update()
        {
