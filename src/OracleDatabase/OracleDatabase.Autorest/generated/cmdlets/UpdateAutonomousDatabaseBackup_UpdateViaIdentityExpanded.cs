...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AutonomousDatabaseBackup_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IAutonomousDatabaseBackup))]
    [global::Sample.API.Description(@"Update a AutonomousDatabaseBackup")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/autonomousDatabases/{autonomousdatabasename}/autonomousDatabaseBackups/{adbbackupid}", ApiVersion = "2023-09-01-preview")]
    public partial class UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IAutonomousDatabaseBackupUpdate _propertiesBody = new Sample.API.Models.AutonomousDatabaseBackupUpdate();
        ...
        public int RetentionPeriodInDays { get => _propertiesBody.RetentionPeriodInDays ?? default(int); set => _propertiesBody.RetentionPeriodInDays = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IAutonomousDatabaseBackup">Sample.API.Models.IAutonomousDatabaseBackup</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAutonomousDatabaseBackup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded
        /// </returns>
        public Sample.API.Cmdlets.UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded Clone()
        {
            var clone = new UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AutonomousDatabaseBackupsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Autonomousdatabasename ?? null, InputObject.Adbbackupid ?? null, _propertiesBody, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeUpdate);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAutonomousDatabaseBackup_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IAutonomousDatabaseBackup> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IAutonomousDatabaseBackup
