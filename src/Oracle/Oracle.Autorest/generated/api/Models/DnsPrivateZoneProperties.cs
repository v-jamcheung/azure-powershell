...
namespace Sample.API.Models
{
    ...
    public partial class DnsPrivateZoneProperties :
        Sample.API.Models.IDnsPrivateZoneProperties,
        Sample.API.Models.IDnsPrivateZonePropertiesInternal
    {
        ...
        bool Sample.API.Models.IDnsPrivateZonePropertiesInternal.IsProtected { get => this._isProtected; set { {_isProtected = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Self</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.Self { get => this._self; set { {_self = value;} } }

        /// <summary>Internal Acessors for Serial</summary>
        int Sample.API.Models.IDnsPrivateZonePropertiesInternal.Serial { get => this._serial; set { {_serial = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime Sample.API.Models.IDnsPrivateZonePropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.Version { get => this._version; set { {_version = value;} } }

        /// <summary>Internal Acessors for ViewId</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.ViewId { get => this._viewId; set { {_viewId = value;} } }

        /// <summary>Internal Acessors for ZoneType</summary>
        string Sample.API.Models.IDnsPrivateZonePropertiesInternal.ZoneType { get => this._zoneType; set { {_zoneType = value;} } }
