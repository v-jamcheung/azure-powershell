...
namespace Sample.API.Models
{
    ...
    public partial class DbNodeProperties :
        Sample.API.Models.IDbNodeProperties,
        Sample.API.Models.IDbNodePropertiesInternal
    {

        /// <summary>Backing field for <see cref="AdditionalDetails" /> property.</summary>
        private string _additionalDetails;

        /// <summary>Additional information about the planned maintenance.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        public string AdditionalDetails { get => this._additionalDetails; }
        ...
        string Sample.API.Models.IDbNodePropertiesInternal.AdditionalDetails { get => this._additionalDetails; set { {_additionalDetails = value;} } }

        /// <summary>Internal Acessors for BackupIPId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.BackupIPId { get => this._backupIPId; set { {_backupIPId = value;} } }

        /// <summary>Internal Acessors for BackupVnic2Id</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.BackupVnic2Id { get => this._backupVnic2Id; set { {_backupVnic2Id = value;} } }

        /// <summary>Internal Acessors for BackupVnicId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.BackupVnicId { get => this._backupVnicId; set { {_backupVnicId = value;} } }

        /// <summary>Internal Acessors for CpuCoreCount</summary>
        int? Sample.API.Models.IDbNodePropertiesInternal.CpuCoreCount { get => this._cpuCoreCount; set { {_cpuCoreCount = value;} } }

        /// <summary>Internal Acessors for DbNodeStorageSizeInGbs</summary>
        int? Sample.API.Models.IDbNodePropertiesInternal.DbNodeStorageSizeInGbs { get => this._dbNodeStorageSizeInGbs; set { {_dbNodeStorageSizeInGbs = value;} } }

        /// <summary>Internal Acessors for DbServerId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.DbServerId { get => this._dbServerId; set { {_dbServerId = value;} } }

        /// <summary>Internal Acessors for DbSystemId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.DbSystemId { get => this._dbSystemId; set { {_dbSystemId = value;} } }

        /// <summary>Internal Acessors for FaultDomain</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.FaultDomain { get => this._faultDomain; set { {_faultDomain = value;} } }

        /// <summary>Internal Acessors for HostIPId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.HostIPId { get => this._hostIPId; set { {_hostIPId = value;} } }

        /// <summary>Internal Acessors for Hostname</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.Hostname { get => this._hostname; set { {_hostname = value;} } }

        /// <summary>Internal Acessors for LifecycleDetails</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.LifecycleDetails { get => this._lifecycleDetails; set { {_lifecycleDetails = value;} } }

        /// <summary>Internal Acessors for LifecycleState</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.LifecycleState { get => this._lifecycleState; set { {_lifecycleState = value;} } }

        /// <summary>Internal Acessors for MaintenanceType</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.MaintenanceType { get => this._maintenanceType; set { {_maintenanceType = value;} } }

        /// <summary>Internal Acessors for MemorySizeInGbs</summary>
        int? Sample.API.Models.IDbNodePropertiesInternal.MemorySizeInGbs { get => this._memorySizeInGbs; set { {_memorySizeInGbs = value;} } }

        /// <summary>Internal Acessors for Ocid</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.Ocid { get => this._ocid; set { {_ocid = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for SoftwareStorageSizeInGb</summary>
        int? Sample.API.Models.IDbNodePropertiesInternal.SoftwareStorageSizeInGb { get => this._softwareStorageSizeInGb; set { {_softwareStorageSizeInGb = value;} } }

        /// <summary>Internal Acessors for TimeCreated</summary>
        global::System.DateTime? Sample.API.Models.IDbNodePropertiesInternal.TimeCreated { get => this._timeCreated; set { {_timeCreated = value;} } }

        /// <summary>Internal Acessors for TimeMaintenanceWindowEnd</summary>
        global::System.DateTime? Sample.API.Models.IDbNodePropertiesInternal.TimeMaintenanceWindowEnd { get => this._timeMaintenanceWindowEnd; set { {_timeMaintenanceWindowEnd = value;} } }

        /// <summary>Internal Acessors for TimeMaintenanceWindowStart</summary>
        global::System.DateTime? Sample.API.Models.IDbNodePropertiesInternal.TimeMaintenanceWindowStart { get => this._timeMaintenanceWindowStart; set { {_timeMaintenanceWindowStart = value;} } }

        /// <summary>Internal Acessors for Vnic2Id</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.Vnic2Id { get => this._vnic2Id; set { {_vnic2Id = value;} } }

        /// <summary>Internal Acessors for VnicId</summary>
        string Sample.API.Models.IDbNodePropertiesInternal.VnicId { get => this._vnicId; set { {_vnicId = value;} } }
