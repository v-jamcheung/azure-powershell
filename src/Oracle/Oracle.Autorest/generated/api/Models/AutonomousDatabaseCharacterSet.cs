...
namespace Sample.API.Models
{
    ...
    public partial class AutonomousDatabaseCharacterSet :
        Sample.API.Models.IAutonomousDatabaseCharacterSet,
        Sample.API.Models.IAutonomousDatabaseCharacterSetInternal,
        Sample.API.Runtime.IValidates
    {
        ...
        public string CharacterSet { get => ((Sample.API.Models.IAutonomousDatabaseCharacterSetPropertiesInternal)Properties).CharacterSet; }
        ...
        private Sample.API.Models.IAutonomousDatabaseCharacterSetProperties _properties;

        /// <summary>The resource-specific properties for this resource.</summary>
        [Sample.API.Origin(Sample.API.PropertyOrigin.Owned)]
        internal Sample.API.Models.IAutonomousDatabaseCharacterSetProperties Properties { get => (this._properties = this._properties ?? new Sample.API.Models.AutonomousDatabaseCharacterSetProperties()); set => this._properties = value; }

        /// <summary>Internal Acessors for CharacterSet</summary>
        string Sample.API.Models.IAutonomousDatabaseCharacterSetInternal.CharacterSet { get => ((Sample.API.Models.IAutonomousDatabaseCharacterSetPropertiesInternal)Properties).CharacterSet; set => ((Sample.API.Models.IAutonomousDatabaseCharacterSetPropertiesInternal)Properties).CharacterSet = value; }

        /// <summary>Internal Acessors for Properties</summary>
        Sample.API.Models.IAutonomousDatabaseCharacterSetProperties Sample.API.Models.IAutonomousDatabaseCharacterSetInternal.Properties { get => (this._properties = this._properties ?? new Sample.API.Models.AutonomousDatabaseCharacterSetProperties()); set { {_properties = value;} } }
        ...
        Sample.API.Models.IProxyResourceInternal
    {
        ...
        /// <summary>The resource-specific properties for this resource.</summary>
        Sample.API.Models.IAutonomousDatabaseCharacterSetProperties Properties { get; set; }
