...
namespace Sample.API.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"VirtualNetworkAddress_Update", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Sample.API.Models.IVirtualNetworkAddress))]
    [global::Sample.API.Description(@"Update a VirtualNetworkAddress")]
    [global::Sample.API.Generated]
    [global::Sample.API.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Oracle.Database/cloudVmClusters/{cloudvmclustername}/virtualNetworkAddresses/{virtualnetworkaddressname}", ApiVersion = "2023-09-01-preview")]
    public partial class SetVirtualNetworkAddress_Update : global::System.Management.Automation.PSCmdlet,
        ...
        Sample.API.Runtime.IContext
    {
        ...
        private Sample.API.Models.IVirtualNetworkAddress _resource;

        /// <summary>Virtual IP resource belonging to a vm cluster resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Virtual IP resource belonging to a vm cluster resource.", ValueFromPipeline = true)]
        [Sample.API.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Sample.API.Models.IVirtualNetworkAddress Resource { get => this._resource; set => this._resource = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IVirtualNetworkAddress">Sample.API.Models.IVirtualNetworkAddress</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IVirtualNetworkAddress> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of SetVirtualNetworkAddress_Update</returns>
        public Sample.API.Cmdlets.SetVirtualNetworkAddress_Update Clone()
        {
            var clone = new SetVirtualNetworkAddress_Update();
            ...
            clone.Virtualnetworkaddressname = this.Virtualnetworkaddressname;
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.VirtualNetworkAddressesCreateOrUpdate(SubscriptionId, ResourceGroupName, Cloudvmclustername, Virtualnetworkaddressname, Resource, onOk, onDefault, this, Pipeline, Sample.API.Runtime.SerializationMode.IncludeCreate);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Cloudvmclustername=Cloudvmclustername,Virtualnetworkaddressname=Virtualnetworkaddressname})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetVirtualNetworkAddress_Update" /> cmdlet class.
        /// </summary>
        public SetVirtualNetworkAddress_Update()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Sample.API.Models.IVirtualNetworkAddress> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Sample.API.Models.IVirtualNetworkAddress
