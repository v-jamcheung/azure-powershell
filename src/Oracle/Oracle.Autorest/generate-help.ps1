...
$modulePsd1 = Get-Item -Path (Join-Path $PSScriptRoot './OracleDatabaseResourceManager.psd1')
$modulePath = $modulePsd1.FullName
$moduleName = $modulePsd1.BaseName

# Load DLL to use build-time cmdlets
Import-Module -Name $modulePath
Import-Module -Name (Join-Path $PSScriptRoot './bin/OracleDatabaseResourceManager.private.dll')
