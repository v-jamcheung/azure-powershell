...
$dll = Join-Path $PSScriptRoot 'bin/OracleDatabaseResourceManager.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom/OracleDatabaseResourceManager.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './OracleDatabaseResourceManager.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'OracleDatabaseResourceManager'
...
$formatPs1xml = Join-Path $PSScriptRoot './OracleDatabaseResourceManager.format.ps1xml'
